...
export default function TodoItem({ task, editTask, deleteTask, toggleComplete }: TodoItemProps & { toggleComplete: (id: number) => void }) {
  ...
  return (
    <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-full px-4 py-3 hover:bg-gray-100 transition-colors duration-200">
      {/* Task Content */}
